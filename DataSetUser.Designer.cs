...
namespace bookLibrary {
    ...
    public partial class DataSetUser : global::System.Data.DataSet {
        ...
        public partial class tbUserDataTable : global::System.Data.TypedTableBase<tbUserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbUserRow AddtbUserRow(string userName, string userPassword, string userType) {
        ...
        public partial class tbUserRow : global::System.Data.DataRow {
            ...
            public bool IsuserTypeNull() {
                return this.IsNull(this.tabletbUser.userTypeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetuserTypeNull() {
                this[this.tabletbUser.userTypeColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace bookLibrary.DataSetUserTableAdapters {
    ...
    public partial class tbUserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `tbUser` WHERE ((`userId` = ?) AND ((? = 1 AND `userName` IS NULL) OR" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `tbUser` (`userName`, `userPassword`, `userType`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `tbUser` SET `userName` = ?, `userPassword` = ?, `userType` = ? WHERE ((`userId` = ?) AND ((? = 1 AND `userName` IS NULL) OR (`userName` = ?)) AND ((? = 1 AND `userPassword` IS NULL) OR (`userPassword` = ?)) AND ((? = 1 AND `userType` IS NULL) OR (`userType` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userId, userName, userPassword, userType FROM tbUser";
        ...
        public virtual int Fill(DataSetUser.tbUserDataTable dataTable) {
        ...
        public virtual DataSetUser.tbUserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetUser.tbUserDataTable dataTable = new DataSetUser.tbUserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetUser.tbUserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_userId, string Original_userName, string Original_userPassword, string Original_userType) {
        ...
        public virtual int Insert(string userName, string userPassword, string userType) {
            if ((userName == null)) {
        ...
        public virtual int Update(string userName, string userPassword, string userType, int Original_userId, string Original_userName, string Original_userPassword, string Original_userType) {
            if ((userName == null)) {
